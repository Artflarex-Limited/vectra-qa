...
try:
    ...
    with sync_playwright() as p:
        ...
        print(f"Panel classes after JS toggle: {panel.get_attribute('class')}")
        
        start_btn = page.locator("button:has-text('Start')")
        print(f"Start button visible after JS toggle: {start_btn.is_visible()}")
        
        page.screenshot(path="/home/bugra/Documents/projects/vectra-qa/.omo/evidence/T17_debug3.png")
