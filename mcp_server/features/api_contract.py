...
class APIContractTester:
    ...
    def load_schema(self, schema_path: str) -> bool:
        ...
        try:
            ...
            logger.info("schema_loaded", path=schema_path, title=self.schema.get("info", {}).get("title", "Unknown"))
            return True
    ...
    async def validate_response(
        ...
        try:
            ...
            matching_logs = [
                log for log in browser.network_logs
    ...
    async def validate_response_body(
        ...
        try:
            ...
            status = "fail" if any(f["severity"] in ["critical", "high"] for f in self.findings) else "pass"
